...
const TermsCard = () => {
  return (
    <div>
      <h4 className="section__sub-title">Terms and conditions</h4>
      <p>
        Draw a line in the sand quick win. My capacity is full. Keep it lean
        gain alignment we need to future-proof this plan.
      </p>
      <h4 className="section__sub-title">AGREEMENT TO OUR LEGAL TERMS</h4>
      <p>
        Via are Company We us our. these legal tenna (the Legal Terms)
        (colactively, the Services) You con contact us ty cine ot or by mail to
        17o10 Los INi0 0000106 0 2ly Chary op obintef mo0b obiwoon you/ whether
        personally or on bahat of an entity (your), and , concerning your access
        to and use of the Senices. You agree that try bosessing the Services.
        you have read, understood, and agroed to be bound by all of these Legal
        Torms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE
        EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE
        USE IMMEDIATELY. Supplemental terma and condtiona or documents that may
        be posted on the Services from time to time are hereby expressly
        incorporated herein by reference. Via reserve the rigge, in our scle
        dscrition, to make changes or modifications 1o these Legal Terms of any
        fime and for ory resson. We will alert you about, any changes by
        updating the Last updated Gate of these Legal Terma, and you waive any
        right to receive specific notice of each such chango. It is your
        responsibity to periodicaly review These Legal Terma to stay informed of
        updates. You wil be subject do, and wil be deemed to have been made
        aware of and to have scoepted, the changes in any revised Legal Terma by
        your continued use of the Senioes, afler the Gt grh med loal ims gopend
      </p>
      <h4 className="section__sub-title">TABLE OF CONTENTS</h4>
      <p>
      ...
      <h4 className="section__sub-title">INTELLECTUAL PROPERTY RIGHTS</h4>
      ...
      <p>
        ...
        service marks, and logos contained therein (the Marks). Our Content and
      ...
      <h4 className="section__sub-title">Your use of our Services</h4>
      <p>
        ...
        your request to: . If we ever grant you the permission to post,
      ...
      <h4 className="section__sub-title">Your Submissions</h4>
      <p>
        ...
        obscene, bullying, abusivel discriminatory, threatening to any person or
        ...
        suffer because of your breach of (a) this section, (b) any third partys
        intellectual property rights, or (c) applicable law.
      </p>
      <h4 className="section__sub-title">USER REPRESENTATIONS</h4>
      <p>
      ...
      <h4 className="section__sub-title">PROHIBITED ACTIVITIES</h4>
      <p>
        ...
        disrupts, alters, or interferes vith the use, features, functions,
        operation, or maintenance of the Services. • Engage in any automated use
        ...
        clear graphics interchange formats (gifs), 1x1 pixels, web bugs,
        cookies, or other similar devices (sometimes referred to as spyware or
        passive collection mechanisms or poms). • Interfere with, disrupt, or
        create an undue burden on the Services or the networks or services
        connected to the Services. • Harass, annoy, intimidate, or threaten any
        ...
        of the Services. • Copy or adapt the Services software, including but
      ...
      <h4 className="section__sub-title">USER GENERATED CONTRIBUTIONS</h4>
      <p>
      ...
      <h4 className="section__sub-title">CONTRIBUTION LICENSE</h4>
      <p>
      ...
      <h4 className="section__sub-title">SERVICES MANAGEMENT</h4>
      <p>
        ...
        Services in a nanner designed to protect our rights and property and to
        facilitate the proper functioning of the services.
      </p>
      <h4 className="section__sub-title">TERM AND TERMINATION</h4>
      <p>
      ...
      <h4 className="section__sub-title">MODIFICATIONS AND INTERRUPTIONS</h4>
      <p>
      ...
      <h4 className="section__sub-title">GOVERNING LAW</h4>
      <p>
        These Legal Terms shall be governed by and defined following the laws of
        and yourself irrevocably consent that the courts of shall have exclusive
        jurisdiction to resolve any dispute which may arise in connection with
        these Legal Terms.
      </p>
      <h4 className="section__sub-title">DISPUTE RESOLUTION</h4>
      <p>
        To expedite resolution and control the cost of any dispute, controversy,
        or claim related to these LAgal Terms (each a Dispute and collectively,
        ...
        informally for clearat least days before initiating arbitration. Such
      ...
      <p>
        ...
        be _ . The seat, or legal place, or arbitration shall be . The language
        of the proceedings shall be • The governing law of these Legal Terms
        shall be substantive law of
      </p>
      <h4 className="section__sub-title">Binding Arbitration</h4>
      ...
      <h4 className="section__sub-title">Restrictions</h4>

      <p>
        The Parties agree that the following Disputes are not subject to the
        above provisions concerning informal negotiations binding arbitration:
        (a) any Disputes seeking to enfirce or protect, or concerning the
      ...
      <h4 className="section__sub-title">CORRECTIONS</h4>

      <p>
        inaccuracies, or omissions, including descriptions, pricing,
        avallability, and various other information. We reserve the right to
        correct any errors, inaccuracies, or omissions and to change or update
        the information on the Services at any time, without prior notice.
      </p>
      <h4 className="section__sub-title"> DISCLAIMER </h4>
      ...
      <h4 className="section__sub-title">LIMITATIONS OF LIABILITY </h4>
      ...
      <h4 className="section__sub-title">INDEMNIFICATION </h4>
      ...
      <p>
        ...
        by any third party due to or arising out of: (1) use of the Services:
        ...
        the Services with whom you connected via the Services. Notwithstanding
        the foregoing, we reserve the right, al your expense, to assume the
        ...
        indemnification upon bacoming aware of it.
      </p>

      <h4 className="section__sub-title">USER DATA</h4>
      <p>
      ...
      <p>
        ...
        jurisdiction which require an original signature Ir delivery or
        retention of non-electronic records, or to payments or the granting of
        credits by any means other than electronic means.
      </p>
      <h4 className="section__sub-title">MISCELLANEOUS</h4>
      ...
      <h4 className="section__sub-title">CONTACT US</h4>
